...
optional arguments:
  ...
  -o OUTPUTDIR, --outputDir OUTPUTDIR
                        ...
                        should be created. Defaults to the same directory
                        as IMAGEDIR.
  -r RATIO, --ratio RATIO
                        The ratio of the number of test images over the total
                        number of images. The default is 0.1.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Partition dataset of images into'
    ...
    parser.add_argument(
        '-o', '--outputDir',
        help='Path to the output folder where the train'
             'and test dirs should be created. '
    ...
    parser.add_argument(
        '-r', '--ratio',
        help='The ratio of the number of test images over the total'
             'number of images. The default is 0.1.',
        default=0.1,
        type=float)
    parser.add_argument(
        '-x', '--xml',
        help='Set this flag if you want the xml annotation files'
             'to be processed and copied over.',
        action='store_true'
    )
